...
class _MostvisitedDetailScreenState
  ...
  double _paddingValue = 80; // 👈 البداية (مشدود للأعلى)

  @override
  void initState() {
    super.initState();

    // 👇 بعد تحميل الصفحة نعمل Animation تلقائي
    Future.delayed(const Duration(milliseconds: 200), () {
      setState(() {
        _paddingValue = 22; // 👈 يرجع لوضعه الطبيعي
      });
    });
  }
                      ...
                      children: [
                        ...
                        const Row(
                          ...
                          children: [
                            ...
                            _InfoIcon(Icons.hotel, "SERVISES FOR TRAVELL"),
